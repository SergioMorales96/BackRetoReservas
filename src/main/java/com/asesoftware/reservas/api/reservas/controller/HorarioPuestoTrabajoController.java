...
public class HorarioPuestoTrabajoController {
	...
	/**
	 * Método que genera el endpoint y llama al servicio, para consultar todos los registros de la tabla HorarioPeustoTrabajo. 
	 * @author jlucero
	 * @param 
	 * @return ResponseDTO
	 */
	...
	/**
	 * Método que genera el endpoint y llama al servicio, le pasa el HorarioPuestoTrabajoDTO para crear un nuevo. 
	 * @author jlucero
	...
	/**
	 * Método que genera el endpoint y llama al servicio, le pasa el id del HorarioPuestoTrabajoDTO para eliminarlo. 
	 * @author jlucero
	 * @param id
	 * @return ResponseDTO
	 */
